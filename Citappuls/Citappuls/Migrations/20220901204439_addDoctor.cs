    ...
    public partial class addDoctor : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialityDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecialityDoctors_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SpecialityDoctors_Specialties_SpecialityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HospitalSpecialities_Specialties_SpecialityId",
                        column: x => x.SpecialityId,
                        principalTable: "Specialties",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalDoctors_HospitalId_DoctorId",
                table: "HospitalDoctors",
                columns: new[] { "HospitalId", "DoctorId" },
                unique: true,
                filter: "[HospitalId] IS NOT NULL AND [DoctorId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalSpecialities_HospitalId_SpecialityId",
                table: "HospitalSpecialities",
                columns: new[] { "HospitalId", "SpecialityId" },
                unique: true,
                filter: "[HospitalId] IS NOT NULL AND [SpecialityId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[DoctorId] IS NOT NULL AND [SpecialityId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialityDoctors_SpecialityId",
                table: "SpecialityDoctors",
                column: "SpecialityId");
